...
const TrackCard = ({ track }) => {
  ...
  /**The second element is an object with information about
   * the mutation: loading, error and data. This component
   * doesn't need it, so we don't have to extract it. */
